...
public class RouterService {
    ...
    public void createRouter(RouterRequest routerRequest) {
    ...
    private RouterResponse mapToRouterResponse(Router router) {
    ...
    public List<Map<String, String>> systemResourcePrint(String ip, String admin, String password) throws MikrotikApiException {
        try {
            ApiConnection connection = ApiConnection.connect(ip);
            connection.login(admin, password);
            List<Map<String, String>> rs = connection.execute("/system/resource/print");
            connection.close();
            return rs;
